...
public class FinalBoss extends Human {
    ...
    public FinalBoss(float x, float y, GameWorldState gameWorld) {
        ...
        attackforward = CacheDataLoader.getInstance().getAnimation("boss_attack_animation");
        attackback = CacheDataLoader.getInstance().getAnimation("boss_attack_animation");
        attackback.flipAllImage();
